...
import { XButton, XTable } from "@lyra/ui";
import leetcode from "~/routes/(backstage)/(library)/data-display/table/dynamic-table/leetcode";

const defaultOffsetControl = { paginationType: "offset", offset: { rows: 10, page: 1 } };
const flux = reactive({
  cols: [
    { key: "name", name: "Name" },
...
<template>
  <div class="my-4 rounded-lg border bg-white p-6 dark:border-slate-600 dark:bg-slate-800">
