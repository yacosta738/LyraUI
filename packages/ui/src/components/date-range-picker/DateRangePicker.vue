		...
		<Fade>
			...
			>
				...
				<template v-if="flux.showWeeks">
					<div class="grid grid-cols-7 grid-rows-7 gap-y-0.5 text-center">
						<div
				...
				<div v-if="flux.showYears" class="grid w-48 grid-cols-4 gap-1 text-center">
					<div
				...
				<div v-if="flux.showMonths" class="grid w-48 grid-cols-3 gap-1 text-center">
					<div
